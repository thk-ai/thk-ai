...
:::{.feature-grid}
:::{.feature-card}
![](figures/news/ksta/th_koeln_campus_gummersbach.png){.feature-card-image fig-alt="TH Köln Gummersbach campus"}

### Kölnische Rundschau: New article series on AI in Oberberg

`2026-04-18` -- Torsten Sülzer launches a series in the Kölnische Rundschau asking how well the Oberbergisch region — with its innovation-driven companies and "hidden champions" and the research-strong TH Köln in engineering and computer science — is positioned for the next industrial revolution.

[Read more](news/ksta/oberberg-ki-serie-en.md){.btn .btn-outline-primary}
:::
