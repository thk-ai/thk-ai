...
:::{.feature-card}
![](figures/news/doktorandenkolloquium-nadirov/teaser.jpg){.feature-card-image fig-alt="Banner of the Computer Science and Data Science department of the Promotionskolleg NRW with the logo of the doctoral college"}

### Doctoral colloquium at IDE+A: Nadir Nadirov on AI-assisted optimization of blisks

`2026-07-23` -- Nadir Nadirov presented results from his doctoral research at the doctoral colloquium of the Institute for Data Science, Engineering, and Analytics (IDE+A) at TH Köln. His talk "An AI-Assisted Computational Framework for Intentional Mistuning and Aeroelastic Optimization of Blisks" combines costly simulations with methods from artificial intelligence to optimize mistuning patterns for integrally bladed rotors in turbomachinery.

[Read more](news/doktorandenkolloquium-nadirov/doktorandenkolloquium-nadirov-en.md){.btn .btn-outline-primary}
:::
