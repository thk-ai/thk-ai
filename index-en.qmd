...
:::{.feature-card}
![](news/puet26a/puet26a_fig1.png){.feature-card-image fig-alt="AgeDB training distribution with extrapolation and interpolation regimes and overlaid model error"}

### Paper "Deconstructing Deep Imbalance Regression" published in Artificial Intelligence Review

`2026-04-28` -- Noah C. Puetz, Jens U. Brandt, Marc Hilbert, Elena Raponi, Thomas Bäck, and [Prof. Dr. Thomas Bartz-Beielstein](https://www.th-koeln.de/personen/thomas.bartz-beielstein/) deliver the first comprehensive review of Deep Imbalanced Regression in *Artificial Intelligence Review*. A two-axis taxonomy organises 19 methods, twelve are re-evaluated under identical conditions, and three new evaluation protocols expose previously hidden failure regimes. DOI: [10.1007/s10462-026-11570-1](https://doi.org/10.1007/s10462-026-11570-1).

[Read more](news/puet26a/puet26a-deep-imbalance-regression-en.md){.btn .btn-outline-primary}
:::
