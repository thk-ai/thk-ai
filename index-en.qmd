...
:::{.feature-grid}
:::{.feature-card}
![](figures/news/vekil/fix_cumulative_hana.png){.feature-card-image fig-alt="Cumulative fix curve from the SAP HANA study"}

### LLMs taking shortcuts in test generation — Report on arXiv

`2026-04-17` -- THK-AI Research Report 2/2026 by Vekil Bekmyradov, Noah C. Pütz, and Prof. Dr. Thomas Bartz-Beielstein on [arXiv:2604.14437](https://arxiv.org/abs/2604.14437): an empirical study of memorisation and generalisation in large language models for automated test generation, contrasting LevelDB with SAP HANA.

[Read more](news/vekil/veki26a-shortcuts-en.md){.btn .btn-outline-primary}
:::
