...
:::{.feature-card}
![](figures/news/bart26c/pareto-front.png){.feature-card-image fig-alt="Pareto-Front zweier Zielgrößen aus der Verdichter-Fallstudie"}

### Beitrag „Multi-Objective Optimization with Desirability and Morris-Mitchell Criterion" für MCDM 2026 angenommen

`28. April 2026` -- Das Programmkomitee der MCDM 2026 hat den Beitrag von [Prof. Dr. Thomas Bartz-Beielstein](https://www.th-koeln.de/personen/thomas.bartz-beielstein/) (TH Köln), Eva Bartz, Alexander Hinterleitner (Bartz & Bartz GmbH) sowie Christoph Leitenmeier und Ihab Abd El Hussein (Everllence SE) zur Präsentation angenommen. Die Arbeit verbindet Desirability-Funktionen mit dem Morris-Mitchell-Kriterium und wird an einer Fallstudie aus der Verdichterentwicklung demonstriert.
